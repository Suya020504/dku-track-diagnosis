...
- [ ] Read new result reference C:/Users/HAPPY/.codex/generated_images/019fae1d-952c-7f52-a1b5-66d624e265e7/exec-96900409-bbe8-4545-8ab2-bde964668792.png. Example input values must be calculated from actual props; no logged-in user menu. Treat source caveats as real but concise information.
...
- [ ] Use dku-results-page as a new root. Main action leads to next page; print/save remains quiet utility. Keep per-section URL and print structure readable, including missing conditions that are collapsed on screen. Provide/verify print expansion rather than losing those facts from exported results.
...
- [ ] Use the existing individual mockup-survey.png and mockup-recommendation.png under design-proposals/full-service-pages-2026-09-02/mockups as secondary layout references with the current page-specific palette and new hierarchy. Exclude any obsolete map/compass/auth/demo-number elements and use real engine results.
...
- [ ] Use design-proposals/full-service-pages-2026-09-02/mockups/mockup-plan.png as a layout reference. Use real result slots and current approved warm planner palette; exclude map/compass/demo-value/auth content.
...
- [ ] App's planner top link always opens the plan-comparison page, so its visible label must describe that destination rather than promise browser history. Keep that callback and the conditional single-main rendering unchanged.
