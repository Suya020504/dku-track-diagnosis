...
const pages = [
  ...
  { id: "curriculum", label: "교육과정", title: "학년·학기별 교과로드맵", body: "배울 과목을 학기별로 비교해 보세요." },
  { id: "timetable", label: "시간표", title: "2026년 2학기 시간표", body: "과목을 찾아 요일과 수업 시간을 확인하세요." },
  { id: "official", label: "학교 자료", title: "학교 자료 바로가기", body: "신청과 수업 준비에 필요한 학교 안내를 모았습니다." },
] as const;
